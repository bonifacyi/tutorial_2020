...
def point_on_ellipse(alpha, a, b, alpha_a, pivot_x, pivot_y):
...
def ellipse_cosmic_body_motion(alpha_start, a, b, alpha_a, pivot_x, pivot_y, dt, period_of_rotation):
    ...
    x, y = point_on_ellipse(alpha_new, a, b, alpha_a, pivot_x, pivot_y)
    return x, y, alpha_new
...
def calculate_remoteness(x, y, pivot_x, pivot_y):
    r = ((x - pivot_x) ** 2 + (y - pivot_y) ** 2) ** 0.5
    return r
